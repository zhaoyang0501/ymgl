                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#">
                            ...
                            <span class="nav-label">冷链管理</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="store/create" >建档</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="store/index" >冷链管理</a>
                            </li>
                    ...
                    <li>
                        <a href="#">
                            ...
                            <span class="nav-label">疫苗管理</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                    ...
                    <li>
                        <a href="mailbox.html"><i class="fa fa-envelope"></i> <span class="nav-label">接种管理 </span><span class="label label-warning pull-right">16</span></a>
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="child/create">儿童信息添加</a>
                            </li>
                            <li><a class="J_menuItem" href="child/index">儿童信息查询</a>
                            </li>
                            <li><a class="J_menuItem" href="inoculation/index">门诊接种</a>
                            </li>
                        </ul>
                    </li>
                    <li>
